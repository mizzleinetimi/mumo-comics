      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white rounded-xl border-3 border-black p-6">
            ...
            <MultiImageUpload onImagesChange={setPanelImages} maxImages={20} />
            <p className="mt-4 text-sm text-gray-600 font-medium">
              📌 <strong>Tip:</strong> First image becomes your cover. Drag to
              reorder panels!
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl border-3 border-black p-6">
            ...
            <p className="mt-2 text-sm text-gray-600 font-medium">
              💡 Leave this blank and we&apos;ll auto-generate content from your
              uploaded panels!
            </p>
          </div>
